        ...
        children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Row(
                              children: const [
                                ...
                                SizedBox(width: 8),
                                Expanded(
                                  child: Text('Львів', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis),
                                ),
                              ],
                            ),
                            const SizedBox(height: 8),
                            const Text('Переважно сонячно', style: TextStyle(color: Colors.white70, fontSize: 16)),
                          ],
                        ),
                        ...
                        const Text('24°C', style: TextStyle(color: Colors.white, fontSize: 56, fontWeight: FontWeight.bold, height: 1)),
                      ],
                    ),
                  ),
                ),
                          ...
                          children: [
                            Row(
                              children: const [
                                ...
                                SizedBox(width: 8),
                                Expanded(
                                  child: Text('Датчик', style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold), overflow: TextOverflow.ellipsis),
                                ),
                              ],
                            ),
                            const SizedBox(height: 8),
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: _isConnecting 
                                        ? Colors.orange 
                                        : (_isMqttConnected ? Colors.greenAccent : Colors.redAccent),
                                  ),
                                ),
                                ...
                                Expanded(
                                  child: Text(
                                    _isConnecting 
                                        ? 'Підключення...' 
                                        : (_isMqttConnected ? 'Підключено' : 'Немає з\'єднання'),
          ...
          Row(
            ...
            children: [
              ...
              _buildWeatherDetail(Icons.water_drop_outlined, 'ВОЛОГІСТЬ', '58%'),

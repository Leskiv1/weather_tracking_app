      ...
      if (value.trim() == "Avada Kedavra") {
        ...
        if (inputNumber != null) {
          ...
          if (_baseTemperature == 50) {
            _systemStatus = "Більше не може бути! Якщо більше, то ядерна війна і нам всім капут!!!";
          } else if (_baseTemperature == -50) {
            _systemStatus = "Менше нема куда! Якщо менше, то передай привіт Сіду з Льoдовикового періоду!!!";
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration( // Прибрали const, бо errorText змінюється
                border: const OutlineInputBorder(),
                labelText: 'Введіть температуру',
                hintText: 'Наприклад: 10 або Avada Kedavra',
                errorText: _errorMessage, // Відображення помилки
              ),
              onSubmitted: _processInput, // Спрацьовує при натисканні Enter на клавіатурі
            ),
          ],
        ),
      ),
